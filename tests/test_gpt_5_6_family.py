...
class Gpt56FamilyRegressionTests(unittest.TestCase):
    ...
    def test_versioned_assets_and_release_metadata_match(self):
        ...
        self.assertIn("'2026-07-31-010'", app_source)
        self.assertIn("'V4.8.659'", app_source)
        for relative_path in (
            "static/js/chat_core.v4.8.659.js",
            "static/css/chat.custom.v4.8.659.css",
            "static/css/chat.tailwind.v4.8.659.css",
            "static/changelogs/20260731_v4.8.659.md",
        ):
