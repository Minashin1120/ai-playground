...
全対応モデルの一覧です。モデル定義の一次ソースは `static/js/chat_core.v4.8.1007.js` の `MODELS` 配列です。
...
| 系統 | 代表モデル | 料金（要約） |
|------|-----------|-------------|
| Gemini 3.8 | gemini-3.8-flash | In $0.75/1M, Out $3.75/1M（2026-12-31までの導入価格） |
...
*最終更新: 2026-09-20 (V4.8.1007)*
*ソース: `static/js/chat_core.v4.8.1007.js` MODELS配列*
