...
[![Version](https://img.shields.io/badge/version-V4.8.1022-2563eb)](static/changelogs/20260923_v4.8.1022.md)
...
- [Androidクライアント開発・接続ガイド](deploy/ANDROID_CLIENT.md)：端末連携、API仕様、ネイティブアプリ、Actionsによる固定署名APK構築・配布、サーバー運用
- [Androidプロジェクト](android/README.md)：Kotlin / Jetpack Composeのアプリ本体とビルド構成
