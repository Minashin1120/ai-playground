...
def chat_stream():
    ...
    options = {
        ...
        'enable_maps': data.get('enable_maps'),
        ...
        'gemini_video_duration': data.get('gemini_video_duration'),
        'gemini_video_aspect': data.get('gemini_video_aspect'),
        'gemini_video_resolution': data.get('gemini_video_resolution'),
