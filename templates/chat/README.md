...
| `main_stage.html` | モバイルヘッダー、Gemini／OpenAI Batch完了バナー、会話コンテナ、Welcome、Canvas パネル | ヘッダー、Batch完了通知、チャット表示、Welcome、Canvas |
...
| `overlay_voice.html` | Lyria スタジオ、Voice スタジオ（音声ドックの拡大表示）、マーカー編集 | 音声スタジオ、画像マーカー |
